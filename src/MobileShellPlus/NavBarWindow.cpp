...
UIElement NavBarWindow::BuildUIElement()
{
    ...
    <Grid>
        ...
        <Button x:Name="btnExit" Margin="16,0,0,0" Padding="0" Grid.Column="0" Height="48" Width="48" HorizontalAlignment="Left" Visibility="Collapsed" VerticalAlignment="Center" Style="{StaticResource CommandBarFlyoutEllipsisButtonStyle}">
